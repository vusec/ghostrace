...
... when exists, any
* FREE_FUNC(OUTERMOST_STRUCT_PTR->FIELD_STRUCT_PTR->FREE_STRUCT_PTR)    @FREE_POSITION
... when exists, any
OUTERMOST_STRUCT_PTR->FIELD_STRUCT_PTR->FREE_STRUCT_PTR = NULL          @NULL_POSITION
... when exists, any
...
pos_null                << free_script.NULL_POSITION;
...
report = {}
report["report_class"] = "guarded_free_null" 
report["report_type"] = "guarded_nested_2_free_null" 
...
report["null_position"] = pos_null[0].__dict__["file"] + " +" + pos_null[0].__dict__["line"]
report["unlock_func"] = unlock_func
report["unlock_position"] = pos_unlock[0].__dict__["file"] + " +" + pos_unlock[0].__dict__["line"]
report["types"] = [f"{outermost_struct_type}", f"{field_struct_type}", f"{free_struct_type}"]
